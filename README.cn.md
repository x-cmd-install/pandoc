...
[![x-cmd/install — pandoc Code Quality Monitoring Repo Card](https://repo.x-cmd.io/pandoc.svg?lang=zh)](https://x-cmd.com/install/pandoc)
...
合计: **121,048** 行代码（覆盖前 5 种语言、共 **603** 个文件）。

| 语言 | 代码 | 注释 | 空行 | 文件数 |
|------|-----:|-----:|-----:|------:|
| Haskell | 101,029 | 12,913 | 9,730 | 365 |
| Xml | 4,491 | 0 | 2 | 47 |
| Lua | 3,236 | 181 | 208 | 48 |
| Yaml | 2,544 | 161 | 54 | 130 |
| Html | 2,243 | 58 | 54 | 13 |
...
- **上游仓库**: <https://github.com/jgm/pandoc>
- **官网**: <https://pandoc.org>
- **许可证**: GPL-2.0
...
- **Star**: 46,357 · **Fork**: 4,410 · **开放 issue**: 8,368 · **贡献者**: 585

## 累计统计

- **发布数**: 159 · **已合并 PR**: 1812 · **开放 PR**: 85 · **已关闭 issue**: 7413 · **开放 issue**: 955 · **提交数**: 19433

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-22 | 1 | 10 | 8 | 20 | 7 | 387 |
| last60d | 2026-07-23 | 2 | 17 | 10 | 39 | 13 | 454 |
| 90d | 2026-06-23 | 3 | 26 | 10 | 58 | 16 | 542 |
| last180d | 2026-03-25 | 4 | 47 | 11 | 128 | 35 | 741 |
| 360d | 2025-09-26 | 11 | 106 | 17 | 269 | 74 | 1176 |
| last720d | 2024-10-01 | 21 | 219 | 26 | 620 | 118 | 1706 |
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/pandoc.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260921.yml` · 2026-09-21T05:06:58Z._
