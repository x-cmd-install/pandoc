...
合计: **120,454** 行代码（覆盖前 5 种语言、共 **603** 个文件）。
...
- **Star**: 46,230 · **Fork**: 3,966 · **开放 issue**: 8,358 · **贡献者**: 583

## 累计统计

- **发布数**: 159 · **已合并 PR**: 1806 · **开放 PR**: 80 · **已关闭 issue**: 7402 · **开放 issue**: 956 · **提交数**: 19341
...
在 [repology.org](https://repology.org/project/pandoc) 上共有 **299** 个发行版报告此项目。**17** 个 ✅ 已是最新上游版本，**129** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T05:01:12Z._
